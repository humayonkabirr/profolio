            ...
            <nav id="sidebar">
                ...
                <ul class="flex-row text-center navbar-nav theme-brand">
                    ...
                    <li class="nav-item theme-text">
                        <a href="index.html" class="nav-link"> Kabir </a>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show recent-submenu mini-recent-submenu" id="starter-kit" data-parent="#accordionExample">
                            <li>
