            ...
            <div class="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="flex items-center justify-center w-full py-24 space-x-2 shadow-lg">
                    <div class="text-[40px] text-gray-300">
                        ...
                        <div class="text-lg">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi sapiente reprehenderit repellat possimus veniam non recusandae eius dignissimos impedit. Officia in placeat accusamus consequatur qui odio a dolorum excepturi autem?</p>
                        </div>
                    </div>
